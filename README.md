...
--source_model_name roberta-base \
--setformer_predictions_path outputs/roberta-base_to_cis-lmu-glot500-base_dim-400/setformer_training_logs/2024-12-09_01-04-10/inference_logs/prediction_dict.pkl
```
