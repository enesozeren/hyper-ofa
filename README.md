...
--checkpoint_path outputs/xlm-roberta-base_to_cis-lmu-glot500-base_dim-400/setformer_training_logs/2024-12-22_21-27-10/checkpoints/model-epoch=09-val_loss=7.4101.ckpt \
--keep_dim 400
```
...
--setformer_predictions_path outputs/xlm-roberta-base_to_cis-lmu-glot500-base_dim-400/setformer_training_logs/2024-12-22_21-27-10/inference_logs/prediction_dict.pkl
```
